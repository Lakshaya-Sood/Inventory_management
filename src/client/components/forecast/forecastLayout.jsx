        ...
        if( item.editMode ) {
            ...
            return(
                <TableRow>
                    ...
                    <TableRowColumn>
                        <TextField id="quantity-input" value={currentValues.qty} onChange={(event)=>self.handleEditChanges(event.target.value,'qty')} />
                    </TableRowColumn>
                    <TableRowColumn>
                    ...
                    <TableRowColumn>
                        <TextField id="percent-input" value={currentValues.percent} onChange={(event)=>self.handleEditChanges(event.target.value,'percent')} />
                    </TableRowColumn>
                    <TableRowColumn>
                        <TextField id="cost-input" value={currentValues.cost} onChange={(event)=>self.handleEditChanges(event.target.value,'cost')} />
                    </TableRowColumn>
                    <TableRowColumn>
                        <TextField id="costPercent-input" value={currentValues.costPercent} onChange={(event)=>self.handleEditChanges(event.target.value,'costPercent')} />
                    </TableRowColumn>
                    <TableRowColumn>
